package com.spring.Best.erp.config;
...
@OpenAPIDefinition(
        info = @Info(
                ...
                description = "Documentation for Enterprise Resource Planning (ERP) System APIs, focusing on Employee Management and Payroll Management.",
                title = "ERP System - Payroll Management",
                version = "1.0.0",
                license = @License(
                        name = "RCA-License",
                        url = "https://rca.ac.rw"
        ...
        servers = {
                @Server(
                        ...
                        url = "http://localhost:9090/Best/api/v1"
                ),
                @Server(
