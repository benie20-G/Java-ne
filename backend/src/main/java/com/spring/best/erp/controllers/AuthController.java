...
import com.spring.Best.erp.dtos.response.ErrorResponse;
import com.spring.Best.erp.dtos.response.JwtTokenResponse;
import com.spring.best.erp.services.EmailService;
import com.spring.best.erp.services.UserService;
...
public class AuthController {
    ...
    public ResponseEntity<String> register(@Valid @RequestBody com.spring.Best.erp.dtos.request.UserRequest request) {
    ...
    @PatchMapping("/verify")
    public ResponseEntity<String> verifyAccount(@Valid @RequestBody com.spring.Best.erp.dtos.request.VerificationRequest request) {
    ...
    @PostMapping("/login")
    public ResponseEntity<JwtTokenResponse> login(@Valid @RequestBody com.spring.Best.erp.dtos.request.LoginRequest request) {
    ...
    @PostMapping("/role")
    public ResponseEntity<String> changeRole(@Valid @RequestBody com.spring.Best.erp.dtos.request.RoleRequest request) {
